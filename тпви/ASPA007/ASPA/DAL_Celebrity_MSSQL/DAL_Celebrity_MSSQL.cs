...
namespace DAL_Celebrity_MSSQL
{
    public class DAL_Celebrity_MSSQL
    {
        public interface IRepository
        {
            ...
            bool UpdCelebrity(Celebrity celebrity);
            ...
            bool UpdLifeevent(Lifeevent lifeevent);
        ...
        public class Repository : IRepository
        {
            ...
            public Repository(string connectionString)
            {
                ...
                // Создаем контекст без вывода в консоль
        ...
        public class Context : DbContext
        {
            ...
            {
                // Просто устанавливаем строку подключения без вывода в консоль
                if (this.ConnectionString == null) 
                {
                    this.ConnectionString = @"Data Source=DESKTOP-T12FKAO\SQLEXPRESS;Initial Catalog=Lab6;Integrated Security=True;TrustServerCertificate=True;";
                }
