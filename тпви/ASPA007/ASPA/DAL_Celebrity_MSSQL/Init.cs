...
namespace DAL_Celebrity_MSSQL
{
    ...
    public class Init
    {
        static string connstring = "Data Source=DESKTOP-T12FKAO\\SQLEXPRESS;Initial Catalog=Lab6;Integrated Security=True;TrustServerCertificate=True;";
        public Init() { }
