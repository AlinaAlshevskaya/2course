...
let user5_copy = {
    ...user5, studies: {
       ...
       exams:[
        ...
        {...user5.studies.exams[1],programming:user5.studies.exams[1].programming,mark:user5.studies.exams[1].mark,mark:10}
       ]
    }
};
console.group("user5");
...
user7.studies.exams[0].professor.articles[0].title="New book";
let user7Copy = {
    ...user7,
    studies: {
      ...user7.studies,
