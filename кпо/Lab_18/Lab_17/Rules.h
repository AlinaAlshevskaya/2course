...
#include"Error.h"
#include "MFST.h"
#define GRB_ERROR_SERIES 600  // Определение базового значения для кодов ошибок, связанных с правилами грамматики.
#define NS(n) GRB::Rule::Chain::N(n)
#define TS(n) GRB::Rule::Chain::T(n)
#define ISNS(n)  GRB::Rule::Chain::isN(n) // Макрос для удобной проверки, является ли символ нетерминалом.
