        ...
        private void Search(object parameter)
        {
            ...
            if (FilterText != null||!string.IsNullOrEmpty(FilterText))
            {
                ...
                else if (this._userView.ContentControl.ItemsSource == UsersToShow)
                {
                    ...
                    {
                        if (user.UserName.ToLower().Contains(FilterText.ToLower()) || user.UserSurename.ToLower().Contains(FilterText.ToLower()) || user.Email.ToLower().Contains(FilterText.ToLower()))
                        {
                ...
                else if (this._userView.ContentControl.ItemsSource == ReviewsToShow)
                {
                    ...
                    {
                        if (review.ReviewText.ToLower().Contains(FilterText.ToLower()) || review.CreationDate.ToString().Contains(FilterText))
                        {
