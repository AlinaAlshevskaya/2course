        ...
        private void Search(object parameter)
        {
            if (FilterText != null)
            {
                if (this._userView.ContentControl.ItemsSource == ProductsToShow)
                {
                    ...
                    filteredProducts = new ObservableCollection<Product>(ProductsToShow.Where(p => p.ProductName.Contains(FilterText)).ToList());
                ...
                else if (this._userView.ContentControl.ItemsSource == OrdersToShow)
                {
                    ...
                    filteredOrders = new ObservableCollection<Order>(OrdersToShow.Where(o => o.User.UserName.Contains(FilterText)).ToList());
                ...
                {
                    ObservableCollection<Review> filteredReviews = new ObservableCollection<Review>();
                    filteredReviews = new ObservableCollection<Review>(ReviewsToShow.Where(r => r.User.UserName.Contains(FilterText)).ToList());
                ...
                else if (this._userView.ContentControl.ItemsSource == UsersToShow)
                {
                    ...
                    filteredUsers = new ObservableCollection<User>(UsersToShow.Where(u => u.UserName.Contains(_filterText)).ToList());
