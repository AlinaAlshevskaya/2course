...
namespace DAL
{
    ...
    public class Repository : IRepository
    {
        ...
        public bool DeleteOrder(Order order)
        {
           Order?orderTodelete = this._context.Orders.FirstOrDefault(o=>o.OrderId == order.OrderId);
            if(orderTodelete is not null)
            {
                List<Review>reviews = this._context.Reviews.Where(r=>r.OrderId==orderTodelete.OrderId).ToList();
