...
namespace lab2._2
{
    public partial class Form1: Form
    {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            {
                if (students[i].avarageB >= 5 && students[i].avarageB < 6) { sum +=120; }
                if (students[i].avarageB >= 6 && students[i].avarageB < 7) { sum +=140; }
                if (students[i].avarageB >= 7 && students[i].avarageB <9) { sum += 165; }
                if (students[i].avarageB >= 9 && students[i].avarageB < 10) { sum += 196; }
            }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            for (int i=0; i < counter; i++)
            {
               ...
               WorkInf.Text += students[i].ToString()+"\n";
                if (students[i].workplase != null) { WorkInf.Text += students[i].workplase.ToString() + "\n";  } else WorkInf.Text += "У студента нет работы\n";
